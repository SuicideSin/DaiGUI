...
function DemoAddon:Init()
  Apollo.RegisterAddon(self, false, "", {"DaiGUI-1.0"})
end
...
function DemoAddon:OnLoad()
  ...
  self.DaiGUI = Apollo.GetPackage("DaiGUI-1.0").tPackage
end
...
function DemoAddon:OnDemo()
          ...
          { -- Slider
            ...
            Events = {
              SliderBarChanged = function(self, wndHandler,wndControl, fValue)
                ...
                wndControl:GetParent():FindChild("DaiGUIDemoProgressBar"):SetProgress(fValue)
              end
            },
          },
  ...
  local tWnd = self.DaiGUI:Create(tWndDefinition)
...
function DemoAddon:OnDemo2()
  ...
  oEventHandler.wnd = self.DaiGUI:Create(tWnd):GetInstance(oEventHandler)
end
...
function DemoAddon:OnDemo3()
  ...
  local wndOne = self.DaiGUI:Create(tWnd1):GetInstance()
  ...
  self.DaiGUI:Create(tBtnToAttach):GetInstance(nil, wndOne) -- first parameter is the event handler table. second parameter is the window to use as a parent (this is passed directly to Apollo.LoadForm's parent argument)
end
